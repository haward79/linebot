...
def get_rain_info(location_name: str, coordinate: Tuple[float, float]) -> tuple:
    ...
    if len(coordinate) == 2:
        ...
        if resp.status_code == 200:
            ...
            try:
                ...
                if len(text) > 0:
                    text = '今天' + location_name + '地區降雨概況如下：\n' + text
        ...
        log('Invalid format for coordinate of the location.', LogType.ERROR)
